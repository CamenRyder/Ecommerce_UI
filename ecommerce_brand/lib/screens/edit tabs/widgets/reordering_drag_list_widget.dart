...
import 'package:ecommerce_brand/screens/edit%20tabs/widgets/tabs_active_widget.dart';
import 'package:ecommerce_brand/screens/edit%20tabs/widgets/tabs_diasble_widget.dart';
        ...
        return ReorderableListView(
              ...
              ? Column(
                  ...
                  children: [
                    ...
                    for (int index = 0; index < _itemsDisable.length; index++)
                      TabsDisableWidget(
                        items: _itemsDisable[index],
                        changeTabs: () {
                          _controller.addActiveTabs(_itemsDisable[index]);
                          setState(() {});
                          Get.back();
                        },
                      )
          ...
          children: [
            for (int index = 0; index < _items.length; index += 1)
              ...
              //     _controller.hideTabsFromFeed(index);
              //     setState(() {});
              //     Get.back();
              //   },
              // ),
