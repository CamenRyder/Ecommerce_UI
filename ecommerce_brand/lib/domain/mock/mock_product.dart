...
class MockProduct {
  ...
  static List<Product> listProductHomeUI = [
    Product(
      name: "Karamen",
      userName: "Thu Hiền Bõ",
      imageUserAva: Assets.imagesImageAvatar01,
      favorite: 38,
      image: Assets.imagesMockFoodImage01,
    ),
    Product(
      ...
      imageUserAva: Assets.imagesImageAvatar01,
      favorite: 38,
      image: Assets.imagesMockFoodImage04,
    ),
    Product(
      name: "Bánh Canh",
      userName: "Minh Hiếu Đoàn",
      imageUserAva: Assets.imagesImageAvatar01,
      favorite: 38,
      image: Assets.imagesMockFoodImage02,
    ),
    Product(
      ...
      imageUserAva: Assets.imagesImageAvatar01,
      favorite: 38,
      image: Assets.imagesMockFoodImage03,
    ),
    Product(
      name: "Bánh xèo miền tây",
      userName: "Anh Bảy",
